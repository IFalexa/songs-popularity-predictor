...
**Source**: [Spotify Top 2000s Mega Dataset](https://www.kaggle.com/datasets/iamsumat/spotify-top-2000s-mega-dataset/data)
...
**Option A: Download ZIP (Recommended for beginners, no Git required)**

1. Visit the repository: https://github.com/IFalexa/songs-popularity-predictor
2. Click the green **`Code`** button → **`Download ZIP`**
3. Extract the ZIP file to your desired location (e.g., Desktop)
4. Open PowerShell and navigate to the extracted folder:
   ```bash
   cd Desktop\songs-popularity-predictor-main
   ```
...
**Don't have Git?** Install it from https://git-scm.com/download/win, then restart PowerShell and run the clone command above.
...
**For Windows (after downloading and extracting ZIP):**
...
### Issue 5: Virtual environment activation fails on Windows
