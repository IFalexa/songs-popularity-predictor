...
if st.session_state["menu"] == "Metrics":
    ...
    col1.metric("R² Score (Explanatory Power)", "0.3025", "Pass Level")
    col2.metric("MAE (Mean Absolute Error)", "9.8946", "-10%Deviation")
    col3.metric("RMSE (Root Mean Squared Error)", "12.2407", "Large Deviation")
    st.html("<hr>")
    ...
    with right:
        ...
        <div>
            ...
            The R² of the random forest regression model is 0.3025, indicating that the model has captured 30.25% of the fluctuation logic in the dataset. It has initially established a prediction benchmark for popularity trends despite the highly complex and subjective market context.<br><br>
            <b>2. Error Trend Interpretation</b><br>
            MAE (9.8946) shows good performance, but RMSE (12.2407) is relatively high, revealing a "black swan effect" in the dataset — that is, some songs, although average in inherent features, achieved extremely high popularity due to external factors, leading to biased predictions.
        </div>
        """, unsafe_allow_html=True)
...
# Module 3: Simulation Prediction
    ...
    with st.container():
        with st.form("predict_form"):
            st.markdown("##### 🎹 Please configure attribute parameters for the simulated son")
